...
elif args.task == 'experiment_possible_higher_accuracy':
...
elif args.task == 'experiment_small_model_select_points':
...
elif args.task == 'experiment_small_model_based_big_model':
...
elif args.task == 'experiment_remove_all_negtive':
